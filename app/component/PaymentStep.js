		...
		<>
			...
			<div className='border-b border-gray-200 p-6'>
				...
				<div className='text-center'>
					<div className='inline-flex items-center justify-center w-16 h-16 rounded-full bg-linear-to-br from-pink-500 to-purple-600 mb-4'>
			...
			<div className='p-6 overflow-y-auto max-h-[calc(90vh-200px)]'>
				...
				<div className='bg-gradient-to-br from-pink-50 to-purple-50 rounded-xl p-6 border border-pink-200 mb-6'>
					<div className='flex items-center justify-between mb-4'>
						...
						<div className='text-right'>
							<div className='text-3xl font-bold bg-linear-to-r from-pink-600 to-purple-600 bg-clip-text text-transparent'>
								{plan.price}
							</div>
						</div>
					</div>
				...
				<button
					onClick={onSubmit}
					className='w-full bg-linear-to-r from-pink-500 to-purple-600 text-white py-4 rounded-xl font-semibold text-lg transition-all duration-300 flex items-center justify-center gap-2 cursor-pointer'>
					Pay {plan.price}
